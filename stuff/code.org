...
#+begin_src python :session :results value :tangle ./../features/extract_features_A.py
...
#    x_stereo, sr = librosa.load(filepath, sr=None, mono=False)  # kaiser_fast
...
: None
** stereo features
#+begin_src python :session :results value :tangle ./../features/stereo_features.py
import librosa
import numpy as np
import sys
